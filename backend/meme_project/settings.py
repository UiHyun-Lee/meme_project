...
# If SECRET_KEY is still missing, fallback to local .env (development mode)
if not SECRET_KEY:
    try:
        SECRET_KEY = env("SECRET_KEY")
    except:
        raise Exception("SECRET_KEY is missing. Set it in .env or Render Env Vars.")
...
#     "https://myfrontend.vercel.app", # deploy
# ]
